...
// Model que retem as informações e faz a mediação entre workers e observa os estados
class BlurViewModel(application: Application) : AndroidViewModel(application) {
    ...
    internal fun applyBlur(blurLevel: Int) {
        ...
        // 3) criar terceira tarefa agora para salvar o arquivo mas soquando estiver carregando
